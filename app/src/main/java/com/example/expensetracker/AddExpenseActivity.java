...
public class AddExpenseActivity extends AppCompatActivity {
    ...
    private void updateExpense() {
        String getExpenseId = expenseModel.getExpenseId();
        String amount = binding.amount.getText().toString();
        String note = binding.note.getText().toString();
        String category = binding.category.getText().toString();
        ...
        ExpenseModel model=new ExpenseModel(expenseModel.getExpenseId(),note,category,type,Long.parseLong(amount), expenseModel.getTime());

        FirebaseFirestore
                .getInstance()
                .collection("expenses")
                .document(expenseModel.getExpenseId())
                .set(model); // Use the new model instance
        finish();
    }
}